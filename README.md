...
#### Debug mode in the local machine with oneAPI MKL

./configure PETSC_ARCH=linux-oneAPI-debug --with-debugging=1 \
--CFLAGS='-diag-disable=10441' --CXXFLAGS='-diag-disable=10441' \
--with-mpi-dir=/opt/intel/oneapi/mpi/latest/ \
--download-scalapack \
--download-slepc \
--download-cmake \
--download-mumps \
...
cat linux-oneAPI-debug/lib/petsc/conf/reconfigure-linux-oneAPI-debug.py 
